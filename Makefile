compiler: lex.yy.c parser.tab.o main.cc
		g++ -g -w -ocompiler parser.tab.o lex.yy.c main.cc SymbolTable.cc SymbolTableBuilder.cc SemanticAnalyzer.cc IntermediateRepresentation.cc BytecodeGenerator.cc StackMachineInterpreter.cc -std=c++14
